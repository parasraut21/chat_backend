...
//   mongoose.connect("mongodb+srv://parasraut821:RFR91cFK5fMmSBZv@cluster0.u7h0aaq.mongodb.net/chat?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true })
//       .then(() => {
...
io.on("connection", (socket) => {
  ...
  socket.on("typing", (data,from) => {
    console.log("typing to - ", data.username ,"----",data._id,"--from--",from)
    socket.broadcast.emit("typing..", { _id: data._id, isTyping: true , from:from});


  })

  socket.on("stopTyping", (data,from) => {
